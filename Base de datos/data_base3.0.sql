...
CREATE TABLE IF NOT EXISTS `mydb`.`Reservas` (
  ...
  INDEX `fk_Reservas_Pistas1_idx` (`Pistas_idPista` ASC, `Pistas_Propietario_idClub` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Partidos` (
  ...
  PRIMARY KEY (`idPartido`, `Pistas_idPista`, `Reservas_idReservas`, `Reservas_Pistas_idPista`, `Reservas_Pistas_Propietario_idClub`),
  INDEX `fk_Partidos_Pistas1_idx` (`Pistas_idPista` ASC) VISIBLE,
  INDEX `fk_Partidos_Reservas1_idx` (`Reservas_idReservas` ASC, `Reservas_Pistas_idPista` ASC, `Reservas_Pistas_Propietario_idClub` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Partidos_Reservas1`
    FOREIGN KEY (`Reservas_idReservas` , `Reservas_Pistas_idPista` , `Reservas_Pistas_Propietario_idClub`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`PartidoJugador` (
  ...
  `Partidos_Pistas_idPista` INT NOT NULL,
  `idPartidoJugador` INT NOT NULL,
  INDEX `fk_PartidoJugador_Jugadores1_idx` (`Jugadores_idJugador` ASC) VISIBLE,
  INDEX `fk_PartidoJugador_Partidos1_idx` (`Partidos_idPartido` ASC, `Partidos_Pistas_idPista` ASC) VISIBLE,
  PRIMARY KEY (`idPartidoJugador`),
  CONSTRAINT `fk_PartidoJugador_Jugadores1`
    FOREIGN KEY (`Jugadores_idJugador`)
    REFERENCES `mydb`.`Jugadores` (`idJugador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PartidoJugador_Partidos1`
    FOREIGN KEY (`Partidos_idPartido` , `Partidos_Pistas_idPista`)
    REFERENCES `mydb`.`Partidos` (`idPartido` , `Pistas_idPista`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
