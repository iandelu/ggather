...
<body class="g-sidenav-show"  background="/assets/img/illustrations/loginBack.jpg">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <!-- End Navbar -->
      ...
      <div>
        <article class="card" style="box-shadow: 0 32px 32px 0 rgba(23, 157, 190, 0.445);">
            ...
            <header class="card__header" style="background-image: url(&quot;https://openarena.es/wp-content/uploads/2019/05/open_arena_instalaciones16.jpg&quot;); margin-top: -5px; width: 101%; margin-left: -2px;">
             <h1 style="color: aliceblue;">Partido de @MANKUCO</h1>
             <h2 style="color: aliceblue;" > Padel </h2>
             <span class="focus-icon"> </span>
             <i  style="left:150px; top:20px; color: rgb(255, 255, 255);" class="fa fa-user" aria-hidden="true"></i>
             <h1 style="left: 170px; color: aliceblue;">2/4</h1>
             </header>
            <div class="card_body">
              <div class="btn-group">
                <div class="slots">
