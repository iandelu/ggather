...
public class JugadorBean implements Serializable {
   ...
   //ValoraciÃ³n del resto de Jugadores
   ...
   */
   ...
   public JugadorBean(String usuario, String nombre, String apellidos, String email, long telefono, String contraseña, Date fechaNacimiento, float valoracionMedia) {
   ...
   public JugadorBean(String usuario, String nombre, String apellidos, String email, long telefono) {
       this.usuario = usuario;
       this.nombre = nombre;
       this.apellidos = apellidos;
       this.email = email;
...
//setters de la clase Jugador
   ...
   //MÃ©todo utilizado para calcular la edad y añadirla al usuario.
