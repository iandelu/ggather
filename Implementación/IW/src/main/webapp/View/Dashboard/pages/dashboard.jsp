...
<body class="g-sidenav-show"  background="/assets/img/illustrations/loginBack.jpg">
                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0">
                      53,000&euro;
                      <span class="text-success text-sm font-weight-bolder">+23,000&euro;</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Jugadores Totales</p>
                    <h5 class="font-weight-bolder mb-0">
                      2,300
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Pistas</p>
                    <h5 class="font-weight-bolder mb-0">
                      19
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Empleados</p>
                    <h5 class="font-weight-bolder mb-0">
                      21
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Deportes Jugados </h6>
              <p class="text-sm ms-2"> (<span class="font-weight-bolder">+23% mas</span>) que la semana pasada </p>
                ...
                <div class="row">
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Padel</p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Futbol 11 </p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Baloncesto</p>
                    </div>
        ...
        <div class="col-lg-7">
          <div class="card">
            <div class="card-header pb-0">
              <h6>Dinero Total Generado</h6>
              <p class="text-sm">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold">25% mas</span> en el mes de mayo
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
