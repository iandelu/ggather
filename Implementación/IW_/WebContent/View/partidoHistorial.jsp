                        ...
                        <h1 style="left: 650px;">4/4</h1>
							...
							<br><span class=Datos-User>Jugadores: </span>
                              ...
                              <i class="fa fa-calendar" aria-hidden="true"></i>
                                        ...
                                        <br>
                              <div class= "wrap-input100" style="left: 400px; bottom:50px">
...
<div class="form-popup" id="myForm">
    <form action="/action_page.php" class="form-container">
      ...
      <input type="text" placeholder="Introducir motivo" name="motivo" required>
  
      <label for="comentario"><b>Comentario</b></label>
      <input type="text" placeholder="Introduce un comentario" name="comentario" required>
  
      <button type="submit" class="btn">Poner Tarjeta</button>
