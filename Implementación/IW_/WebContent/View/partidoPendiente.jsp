			...
			<div class="wrap-menuPerfil">
                    ...
                    <header class="card__header" style="background-image: url(&quot;https://openarena.es/wp-content/uploads/2019/05/open_arena_instalaciones16.jpg&quot;); margin-top: -5px; width: 101%; margin-left: -2px;">
                        ...
                        <h1 style="left: 650px;">2/4</h1>
                            ...
                            <br><br><img  style="left:630px; top:20px;" src="images/icons/mankuco.PNG" alt="IMG"  class="fotoJugador"  aria-hidden="true" onclick="location.href='menuPerfil.html'"></i> 
                            ...
                            <div><button class="partido-btn-cancelar" onclick="location.href='partido.html'">
                                Cancelar Partido
                            </button>
